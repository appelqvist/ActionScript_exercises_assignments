	...
	public class Instructions extends Sprite implements IState {
		...
		public function Instructions(document:Document){
			...
			_document = document;
 			...
 			_lblInstruction = new Label("GAME INSTRUCTIONS", 60, Config.WHITE, "Ostrich",true);
			...
			_lblHowToServe = new Label("PRESS SPACE TO SERVE", 40, Config.WHITE, "Ostrich", true);
